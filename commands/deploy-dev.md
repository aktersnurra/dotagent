...
4. Resolve the full Git commit ID with
   `jj log --no-graph -r "@" --template 'commit_id ++ "\n"'`. Do not use Git `HEAD`.
...
Do not create, amend, rebase, or push any bookmarks. This command moves only the `dev`
tag.
