...
assert_contains 'focus_pane_left = "ctrl+alt+left"' "$repo_dir/herdr/config.toml"
assert_contains 'focus_pane_down = "ctrl+alt+down"' "$repo_dir/herdr/config.toml"
assert_contains 'focus_pane_up = "ctrl+alt+up"' "$repo_dir/herdr/config.toml"
assert_contains 'focus_pane_right = "ctrl+alt+right"' "$repo_dir/herdr/config.toml"
assert_contains 'previous_workspace = "ctrl+alt+r"' "$repo_dir/herdr/config.toml"
assert_contains 'next_workspace = "ctrl+alt+g"' "$repo_dir/herdr/config.toml"
assert_contains 'previous_agent = "ctrl+alt+s"' "$repo_dir/herdr/config.toml"
assert_contains 'next_agent = "ctrl+alt+t"' "$repo_dir/herdr/config.toml"
assert_contains 'last_pane = "ctrl+alt+a"' "$repo_dir/herdr/config.toml"
assert_contains 'key = "ctrl+alt+o"' "$repo_dir/herdr/config.toml"
