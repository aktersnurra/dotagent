...
func TestAddition(t *testing.T) {
    hegel.Test(t, func(ht *hegel.T) {
        a := hegel.Draw(ht, hegel.Integers(0, 99))
        b := hegel.Draw(ht, hegel.Integers(0, 99))
        if a+b < a || a+b < b {
            ht.Fatal("overflow")
        }
    })
...
hegel.Test(t, func(ht *hegel.T) {
    ...
    slice := hegel.Draw(ht, hegel.Lists(hegel.Integers(math.MinInt, math.MaxInt)).MinSize(n).MaxSize(n))
    // ...
})
```
...
func TestReverse(t *testing.T) {
    hegel.Test(t, func(ht *hegel.T) {
        xs := hegel.Draw(ht, hegel.Lists(hegel.Integers(math.MinInt, math.MaxInt)))
